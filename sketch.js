...
function draw() {
  ...
  box7.display("purple", "pink");
  box8.display("purple", "pink");
  box9.display("purple", "pink");
  box10.display("rosewood", "pink");
  box11.display("taffy", "pink");
  box12.display("taffy", "pink");
  box13.display("orange", "pink");
  box14.display("orange", "pink");
  box15.display("yellow", "pink");
